...
export function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var authHeader, adminKey, body, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    authHeader = request.headers.get('Authorization');
                    adminKey = authHeader === null || authHeader === void 0 ? void 0 : authHeader.replace('Bearer ', '');
                ...
                case 4:
                    error_1 = _a.sent();
                    return [2 /*return*/, new Response(JSON.stringify({ error: error_1 }), {
                            status: 500,
                            headers: { 'Content-Type': 'application/json' }
                        })];
